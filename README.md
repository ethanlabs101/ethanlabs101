...
| 💾 [NeoWave Bash](https://github.com/ethanlabs101/neowave-bash-legacy) | ***Legacy edition of NeoWave Lua. Displays original bash engine, as well as limitations versus its Lua successor.*** | ✅
| 🌊 [NeoWave Lua](https://github.com/ethanlabs101/neowave-lua) | ***Neofetch/Fastfetch customization engine. Full config engine, custom logos, colors, module overrides, backups, and more.*** | 🚧
